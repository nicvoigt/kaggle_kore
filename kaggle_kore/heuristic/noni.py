...
def uebergeordnete_steuerung(board, me, turn, spawn_cost, kore_left, max_spawn) -> List[Type[ShipyardAction]]:
    """
...
def agent(obs, config):
    ...
    # leite aktionen aus spielphase ab -> aktion
    # Uebergeordnete Idee
    output_us = uebergeordnete_steuerung(board, me, turn, spawn_cost, kore_left, max_spawn)
    ...
    for shipyard in me.shipyards:
        ...
        if output_us == ["early"]:
            ...
            if shipyard.ship_count >0:
                shipyard.next_action =  send_ships_in_random_directions(no_ships_to_send = shipyard.ship_count)
